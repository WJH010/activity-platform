...
import (
	...
	"activity-platform/internal/agent/rag/pipeline"
	...
	userctr "activity-platform/internal/user/controller"
	userrepo "activity-platform/internal/user/repository"
	usersvc "activity-platform/internal/user/service"

	filectr "activity-platform/internal/file/controller"
	filerepo "activity-platform/internal/file/repository"
	filesvc "activity-platform/internal/file/service"

	msgctr "activity-platform/internal/message/controller"
	msgrepo "activity-platform/internal/message/repository"
	...
	agentctr "activity-platform/internal/agent/controller"
	agentrepo "activity-platform/internal/agent/repository"
	agentsvc "activity-platform/internal/agent/service"
